...
const KeywordTierTable = () => {
  ...
  // 침잠: 153 증돈, 152 절쟈, 120 죽나상, 118 와히스, 61 디로쟈, 114 디뫼, 85 디루, 94 치티스, 41 해녀마엘, 79 동상, 96 퐁그렉, 97 버파우
  const D = [153, 152, 120, 118, 61, 114, 85, 94, 41, 79, 96, 97];

  // 호흡: 151 흉상, 132 탕후루, 132 탕히스, 88 검르소, 98 넬슈, 75 섕싱, 78 검상, 89 검파우, 87 검돈, 54 섕티스
  const E = [151, 132, 131, 88, 98, 75, 78, 89, 87, 54];
