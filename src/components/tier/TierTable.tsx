...
const TierTable = () => {
  ...
  // S+:  153 증돈, 152 절쟈, 100 약상, 147 흑파우, 139 동섕돈, 119 적슈, 98 넬슈, 150 뇌뫼, 123 섕르소, 132 탕루, 131 탕히스, 118 마히스, 122 츠이스, 128 돌로쟈, 149 엄싱, 75 섕싱
  const S = [
    153, 152, 100, 147, 139, 119, 98, 150, 123, 132, 131, 118, 122, 128, 149,
    75,
  ];

  // S:   151 흉상, 120 죽나상, 13 후파우, 137 리상, 130 실돈키, 85 디루, 148 시춘마엘, 146 흑쟈, 121 제로쟈, 61 디로쟈,
  //       72 쥐싱, 129 제싱클, 103 런싱, 138 불그렉, 145 흑그렉

  const A = [
    151, 120, 13, 137, 130, 85, 148, 146, 121, 61, 72, 129, 103, 138, 145,
  ];
