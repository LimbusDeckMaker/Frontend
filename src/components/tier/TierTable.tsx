...
const TierTable = () => {
  ...
  // S+:  100 약상, 147 흑파우, 139 동섕돈, 119 적슈, 98 넬슈, 150 뇌뫼, 123 섕르소, 132 탕루, 131 탕히스, 118 마히스, 122 츠이스, 128 돌로쟈, 149 엄싱, 75 섕싱
  const S = [
    100, 147, 139, 119, 98, 150, 123, 132, 131, 118, 122, 128, 149, 75,
  ];
